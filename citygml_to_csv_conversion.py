...
DATA_DIR = "/Users/Kevin/Projects/CityGML_Processing/data/GML/"
...
for file_name in os.listdir(DATA_DIR):
    if file_name.endswith(".gml"):
        gml_file_paths.append(DATA_DIR + file_name)
...
for file_path in gml_file_paths:
    ...
    for building_class in tqdm(building_classes):
        building_data[building_class.id] = {
            ...
            "City": building_class.city,
            "Street": building_class.streetName,
            "StreetNumber": building_class.streetNumber,
            "Gemeindeschluessel": building_class.gemeindeschluessel,
            "RoofData": building_class.roofdata,
            "WallData": building_class.walldata,
            "GroundData": building_class.grounddata,
            "Datenquelle_Dachhoehe": building_class.datenquelle_dachhoehe,
            "DatenquelleBodenhoehe": building_class.datenquelle_bodenhoehe,
            "DatenquelleLage": building_class.datenquelle_lage,
            "BuildingFunction": building_class.bldg_function,
            "RooftopType": building_class.bldg_roofType,
            "MeasuredHeight": building_class.bldg_measuredHeight,
...
print(
    f"There should be {check_sum} buildings available in the dataframe. There are {len(rooftop_data_df.Building_ID.unique())} buildings available."
)
